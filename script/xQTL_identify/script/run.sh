...
## for example
## sh run.sh ../data/mlm_GC_drought_5.00.txt ../data/mlm_GC_normal_5.00.txt ../data/sorted_mGWAS_sig_snp.all.hmp ../../../data/ZmB73_5b_FGS_GeneOnly.gff3 10000 ../result/mlm_GC_5.00_20kb_0.1 T 0.1
