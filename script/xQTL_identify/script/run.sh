...
awk '{print $8}' ${prefix}_xQTL_final_pGWAS_result.txt | sed '1d' > ${prefix}_query1.txt
python ~/tools/maize_annotation/auto-annotation.py ${prefix}_query1.txt ${prefix}_final_pGWAS_anno.txt
